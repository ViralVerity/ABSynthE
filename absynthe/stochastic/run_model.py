            ...
            if len(case_list) != 0 and day >= start_day: #If there are new cases on this day
                for focal_case in case_list:
                    ...
                    #Test that this only comes up when type = Individual
                        ...
                        if config["write_file"]:
                            config["info_file"].write(f'{focal_individual.unique_id},{focal_individual.parent.unique_id},{focal_individual.hh},{focal_individual.ch},{focal_individual.dist},{day},{day+focal_individual.incubation_day},{focal_individual.death_state},{day+focal_individual.incubation_day+focal_individual.death_day},{day+focal_individual.incubation_day+focal_individual.recovery_day},{day + focal_individual.incubation_day}\n')
